...
package object scalatra {
  ...
  @deprecated("Use skinny.micro.SkinnyMicroServlet instead", since = "1.0.0")
  type ScalatraServlet = skinny.micro.SkinnyMicroServlet

  @deprecated("Use skinny.micro.SkinnyMicroFilter instead", since = "1.0.0")
  type ScalatraFilter = skinny.micro.SkinnyMicroFilter

  @deprecated("Use skinny.micro.SkinnyMicroException instead", since = "1.0.0")
