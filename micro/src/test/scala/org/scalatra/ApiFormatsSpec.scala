...
import skinny.micro.{ SkinnyMicroServlet, ApiFormats }
import skinny.micro.routing.{ RailsPathPatternParser, RouteMatcher }

import scala.language.implicitConversions

import org.scalatra.test.specs2.MutableScalatraSpec

class ApiFormatsServlet extends SkinnyMicroServlet with ApiFormats {
