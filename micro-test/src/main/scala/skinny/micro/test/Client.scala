...
trait Client extends ImplicitConversions {
  ...
  private[this] val _response = new DynamicVariable[ClientResponse](null)
  ...
  def post[A](uri: String, params: (String, String)*)(f: => A): A = post(uri, params)(f)
  ...
  def post[A](
    ...
    post(
      ...
      headers = Seq("Content-Type" -> "application/x-www-form-urlencoded;charset=utf-8") ++ headers)(f)
  }
  ...
  def put[A](uri: String, params: (String, String)*)(f: => A): A = put(uri, params)(f)

  def put[A](uri: String, params: Iterable[(String, String)])(f: => A): A = put(uri, params, Map[String, String]())(f)
